...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Deposit gate permanently disabled for Liz Wendy Cedeño (permanent
    // business decision — no upfront deposit required for any artist).
    // All payment infrastructure (clover-store, webhook, rescue system)
    // remains in place but unreached. Change this condition to restore.
    if (false && requestArtistId === 'liz') {
